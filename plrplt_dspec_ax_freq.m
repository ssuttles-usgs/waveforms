function hp=plrplt_dspec_ax_freq(ax,S,tstr,ca,cb)
...
set(hxl,'position',[hxl_pos(1) hxl_pos(2)+0.05 hxl_pos(3)])
end

caxis([clim1 clim2]);
tstr=sprintf('Directional Wave Spectra: %s',tstr)
text(0.6,0,tstr,'fontsize',10,'fontweight','bold','horizontalalignment','center')
