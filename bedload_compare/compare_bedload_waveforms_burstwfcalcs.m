...
%  
 ...
 % STEVE's WAVEFORM
load('..\mat\vandera_bedld_directwaveform_abreufit.mat','bedldx_wfr','R','Beta','Ur');
...
load('..\mat\vandera_bedld_allwaveforms_burstwfcalcs_bp.mat','bedldx_allwaveform','R','Beta','Ur')
...
load('..\mat\vandera_bedld_directwaveform_abreufit_burstwfcalcs_wt.mat','bedldx_wfr','R','Beta','Ur');
...
title('Cummulative Bedload comparison from Fire Island 2014 site 3 using near-bed 9917adv','fontweight','bold') 
...
save2pdf('bedload_compare_abreufit_burstwfcalcs_wt',gcf,300)
