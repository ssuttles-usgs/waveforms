...
%  
 ...
 % STEVE's WAVEFORM
load('..\mat\vandera_bedld_directwaveform_abreufit_d50pt6.mat','bedldx_wfr','R','Beta','Ur');
...
load('..\mat\vandera_bedld_allwaveforms_burstwfcalcs_bp_d50pt6.mat','bedldx_allwaveform','R','Beta','Ur')
...
load('..\mat\vandera_bedld_directwaveform_abreufit_burstwfcalcs_wt_d50pt6.mat','bedldx_wfr','R','Beta','Ur');
...
% MPM bedload 
load('..\mat\mpm_only_ss_d50pt6.mat');
...
set(gca,'ylim',[0 0.35]);
title('Cummulative Bedload comparison from Fire Island 2014 site 3 using near-bed 9917adv (d_{50} = 0.6 mm)','fontweight','bold') 
...
save2pdf('bedload_compare_abreufit_burstwfcalcs_wt_d50pt6',gcf,300)
