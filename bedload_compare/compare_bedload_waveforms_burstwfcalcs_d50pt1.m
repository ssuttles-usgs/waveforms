...
%  
 ...
 % STEVE's WAVEFORM
load('..\mat\vandera_bedld_directwaveform_abreufit_d50pt1.mat','bedldx_wfr','R','Beta','Ur');
...
load('..\mat\vandera_bedld_allwaveforms_burstwfcalcs_bp_d50pt1.mat','bedldx_allwaveform','R','Beta','Ur')
...
%load('/media/taran/DATADRIVE2/Obs_data/matfiles/vandera_bedld.mat','bedldx','R','Beta','Ur');
load('..\mat\vandera_bedld_allwaveforms_burstwfcalcs_bp_nostream_d50pt1.mat','bedldx_allwaveform','R','Beta','Ur')
...
load('..\mat\vandera_bedld_directwaveform_abreufit_burstwfcalcs_wt_d50pt1.mat','bedldx_wfr','R','Beta','Ur');
...
% MPM bedload 
load('..\mat\mpm_only_ss_d50pt1.mat');
bedld_mpm=qb_measured;
dn_mpm=dn(~isnan(bedld_mpm));
cumbedld_mpm=cumtrapz(dn_mpm,bedld_mpm(~isnan(bedld_mpm))).*86400;  

% %Sig direct waveform
load('..\mat\vandera_bedld_directwaveform_abreufit_burstwfcalcs_sig_d50pt1.mat','bedldx_wfr','R','Beta','Ur');
...
set(gca,'ylim',[0 0.35]);
title('Cummulative Bedload comparison from Fire Island 2014 site 3 using near-bed 9917adv (d_{50} = 0.1 mm)','fontweight','bold') 
...
save2pdf('bedload_compare_abreufit_burstwfcalcs_wt_d50pt1',gcf,300)
