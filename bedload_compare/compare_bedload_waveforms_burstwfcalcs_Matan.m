...
%  load('..\mat\skewness_steve.mat','dn') 
 ...
 % STEVE's WAVEFORM
load('C:\Users\ssuttles\data\Matanzas\proc\mat\vandera_bedld_directwaveform_abreufit_Matan.mat','bedldx_wfr','R','Beta','Ur','dn');
...
load('C:\Users\ssuttles\data\Matanzas\proc\mat\vandera_bedld_allwaveforms_burstwfcalcs_bp_d50pt23.mat','bedldx_allwaveform','R','Beta','Ur','dn')
...
load('C:\Users\ssuttles\data\Matanzas\proc\mat\vandera_bedld_directwaveform_abreufit_Matan_wt.mat','bedldx_wfr','R','Beta','Ur','dn');
...
% MPM bedload 
load('C:\Users\ssuttles\data\Matanzas\proc\mat\mpm_only_ss_Matan.mat','Su_skewness','qb_measured','bedload_measured');
...
set(gca,'ylim',[0 0.35]);
title('Cummulative Bedload comparison from Matanzas Inlet site A using near-bed 11109vec (d_{50} = 0.23 mm)','fontweight','bold') 
...
legend({'all waveforms direct' 'wfr_{avg}' 'wfr_{wt}' 'mpm_{ss}'},'Location','Northwest','box','off')


% saveas(gcf,'bedload_compare_ubs.png','png')
save2pdf('bedload_compare_Matan',gcf,300)
