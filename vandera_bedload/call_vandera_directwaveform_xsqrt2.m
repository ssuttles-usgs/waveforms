...
% AVERAGED WAVEFORM 
umax=[wfr.umax]*sqrt(2); 
umin=[wfr.umin]*sqrt(2);
T_c=[wfr.Tc];
T_t=[wfr.Tt];
T_cu=[wfr.Tcu];
T_tu=[wfr.Ttu] ; 
T=[wfr.T] ; 
%R=[wfr.R] ;
uhat=[wfr.Uw]*sqrt(2);% Multiplying this by 2 led to the old plot of bedload
%  
 for ii=1:nt2
 ...
 save('..\mat\vandera_bedld_directwaveform_xsqrt2.mat','bedldx_wfr','R','Beta','Ur')
