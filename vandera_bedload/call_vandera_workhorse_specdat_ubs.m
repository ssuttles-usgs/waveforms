...
load('..\mat\vspec_uhat_tr_ses.mat','uhat_wh','Tr_wh')
ubs_wh=uhat_wh.*sqrt(2);
...
%t_end=2000 ;
 for i=nt1:nt2
   [bedldx_wh_vspec_ubs(i), bedldy(i), Ur(i), R(i), Beta(i)]=vandera_function_workhorse(i, Hs(i), Tr_wh(i), h(i), d50, d90, .....
                                                  umag_curr, phi_curwave, ubs_wh(i), .....
                                                  Zref, delta, waveavgd_stress_term, surface_wave,current_time);
 end 
 save('..\mat\vandera_bedld_workhorse_ubspecdat_ubs.mat','bedldx_wh_vspec_ubs','R','Beta','Ur')
