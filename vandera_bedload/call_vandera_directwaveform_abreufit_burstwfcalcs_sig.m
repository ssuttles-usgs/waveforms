...
%
load('..\waveforms\mat\9917adv_wfr_abreufit_burstwfcalcs_sig.mat')
% AVERAGED WAVEFORM 
umax=[wfr.umax]; 
umin=[wfr.umin];
T_c=[wfr.Tc];
...
%  
 ...
 save('..\mat\vandera_bedld_directwaveform_abreufit_burstwfcalcs_sig_d50_1mm.mat','bedldx_wfr','R','Beta','Ur')
