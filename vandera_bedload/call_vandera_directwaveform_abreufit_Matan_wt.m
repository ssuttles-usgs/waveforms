...
%
load('C:\Users\ssuttles\data\Matanzas\proc\mat\11109vec_wfr_abreufit_burstwfcalcs_wt')
% AVERAGED WAVEFORM
dn=[wfr.dn];
umax=[wfr.umax]; 
umin=[wfr.umin];
...
%  
 ...
 save('C:\Users\ssuttles\data\Matanzas\proc\mat\vandera_bedld_directwaveform_abreufit_Matan_wt.mat','bedldx_wfr','R','Beta','Ur','dn')
