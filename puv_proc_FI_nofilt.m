...
%       v=iwavesbp(v,fs,T_long,T_short);
     ...
     velu_skew=UBS(n).ur_sk;
     velv_skew=UBS(n).vr_sk;
...
save C:\Users\ssuttles\data\FireIsland\analysis\site3\mat\puv_proc_FI_nofilt dn depth PUV UBS raw p_sk k Ur Hs peakF peakDir peakSpread
% 
% figure(5); clf
% subplot(411)
